...
Given a risk neutral outlook, Policy A leads to an expected present value of climate damages up to 2100 of `r round(0.5*policy_compare_f(warming_df$damages_baseline) + 0.5*policy_compare_f(warming_df$damages_baseline_1.5))`. Policy B has an expected present value of `r round(policy_compare_f(warming_df$damages_baseline_b))`.

```{r}
# Create df for graphing cost comparison
policy_compare_df <- data.frame(matrix(ncol = 1, nrow = 79))

# Create column x (costs of Policy B) for graphing. I chose an arbitrary range of values from 0 to 78 x 10^14 for illustrative purposes
...
Policy B leads to less societal cost considering climate damages and policy implementation costs when implementation costs are less than `r round((0.5*policy_compare_f(warming_df$damages_baseline) + 0.5*policy_compare_f(warming_df$damages_baseline_1.5)) - policy_compare_f(warming_df$damages_baseline_b), 2)`. Thus, I recommend Congress pursue Policy B if expected implementation costs of the policy are less than `r round((0.5*policy_compare_f(warming_df$damages_baseline) + 0.5*policy_compare_f(warming_df$damages_baseline_1.5)) - policy_compare_f(warming_df$damages_baseline_b), 2)`, and I recommend Congress pursue Policy A if expected implementation costs of Policy B are more than `r round((0.5*policy_compare_f(warming_df$damages_baseline) + 0.5*policy_compare_f(warming_df$damages_baseline_1.5)) - policy_compare_f(warming_df$damages_baseline_b), 2)`.
